...
from utils.distributed_utils import shard_llm
...
def main(config: omegaconf.DictConfig):
    logger.info(f"Starting CWIC distillation training")
    ...
    logger.info(f"training with world size {dist.get_world_size()}!")
    ...
    shard_llm(teacher_model, mesh)
    shard_llm(student_model, mesh)
    logger.info("Sharded models!")
